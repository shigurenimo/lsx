...
var Component, ref$, createClass, div, a, p, Test, main, render;
Component = __webpack_require__(51).Component;
ref$ = __webpack_require__(86), createClass = ref$.createClass, Component = ref$.Component, div = ref$.div, a = ref$.a, p = ref$.p;
Test = createClass((function(superclass){
...
main = createClass({
  render: function(){
    return div([], div([], 'r'), div([], div([], 'hello'), Test([{
      test: 's'
    }], a([]), a([], 'world'))), div([{
      className: 'q'
    }]), div([{
...
render = __webpack_require__(87).render;
...
//# sourceMappingURL=/Users/takata/Bitbucket/lsx/node_modules/livescript-loader/index.js!/Users/takata/Bitbucket/lsx/sample/index.ls.map
