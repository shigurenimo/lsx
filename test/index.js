...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDOM, ref$, createClass, Component, type, div, a, p, testDiv, main;
	ReactDOM = __webpack_require__(1);
	ref$ = __webpack_require__(147), createClass = ref$.createClass, Component = ref$.Component, type = ref$.type, div = ref$.div, a = ref$.a, p = ref$.p;
	testDiv = createClass((function(superclass){
	  var prototype = extend$(import$(constructor, superclass), superclass).prototype;
	  function constructor(props){
	    constructor.superclass.call(this, props);
	    this.state = {
	      num: []
	    };
	  }
	...
	main = createClass({
	  render: function(){
	    return div([], div([], 'r'), div([], div([], 'hello'), testDiv([{
	      test: 's'
	    }], a([]), a([], 'world'))), div([{
	      className: 'q'
	    }]), div([{
	...
	window.onload = function(){
	  ...
	  'app'));
	  return ReactDOM.render(main([]), document.querySelector(
	  'app'));
	};
	...
	//# sourceMappingURL=/Users/sakana/Plug/lsx/node_modules/livescript-loader/index.js!/Users/sakana/Plug/lsx/test/index.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React, process, createClass, html, svg;
	...
	html = ['a', 'abbr', 'address', 'area', 'article', 'aside', 'audio', 'b', 'base', 'bdi', 'bdo', 'big', 'blockquote', 'body', 'br', 'button', 'canvas', 'caption', 'cite', 'code', 'col', 'colgroup', 'data', 'datalist', 'dd', 'del', 'details', 'dfn', 'dialog', 'div', 'dl', 'dt', 'em', 'embed', 'fieldset', 'figcaption', 'figure', 'footer', 'form', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'head', 'header', 'hgroup', 'hr', 'html', 'i', 'iframe', 'img', 'input', 'ins', 'kbd', 'keygen', 'label', 'legend', 'li', 'link', 'main', 'map', 'mark', 'menu', 'menuitem', 'meta', 'meter', 'nav', 'noscript', 'object', 'ol', 'optgroup', 'option', 'output', 'p', 'param', 'picture', 'pre', 'progress', 'q', 'rp', 'rt', 'ruby', 's', 'samp', 'script', 'section', 'select', 'small', 'source', 'span', 'strong', 'style', 'sub', 'summary', 'sup', 'table', 'tbody', 'td', 'textarea', 'tfoot', 'th', 'thead', 'time', 'title', 'tr', 'track', 'u', 'ul', 'var$', 'video', 'wbr'].map(function(tag){
	  return exports[tag] = function(){
	    return React.DOM[tag].apply(this, process(arguments));
	  };
	});
	svg = ['circle', 'clipPath', 'defs', 'ellipse', 'g', 'image', 'line', 'linearGradient', 'mask', 'path', 'pattern', 'polygon', 'polyline', 'radialGradient', 'rect', 'stop', 'svg', 'text', 'tspan'].map(function(tag){
	  return exports[tag] = function(){
	    return React.DOM[tag].apply(this, process(arguments));
	  };
	});
	//# sourceMappingURL=/Users/sakana/Plug/lsx/node_modules/livescript-loader/index.js!/Users/sakana/Plug/lsx/index.ls.map
